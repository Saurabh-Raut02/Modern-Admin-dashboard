...
import { Ecommerce, Orders, Employees, Stacked, Pyramid, Kanban, Line, Area, Bar, Pie, Financial, ColorMapping, Editor, Calendar, ColorPicker, Customers } from './Pages';
      ...
      <div  className="flex relative dark:bg-main-dark-bg">
        ...
        <div>
          ...
          <Routes>
            ...
            <Route path='/color-pyramid' element={<Pyramid/>}/>
            <Route path='/color-stacked' element={<Stacked/>}/>
          </Routes>
        </div>
        <Footer />
        </div>
